...
% ---- SciML results / Discussion / Conclusion: COMMENTED OUT ----
% These blocks depend on the training runs (currently in progress) and contain
% only placeholder tables/figures. Uncomment and fill in once results are ready.
\begin{comment}
\begin{newtext}
