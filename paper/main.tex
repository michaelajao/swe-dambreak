...
\paragraph{Classical schemes remain the accuracy-per-cost reference.} No neural method approaches the classical finite-volume error at the training budget used here; a single solver run is both faster and more accurate than training any of the networks for one instance. The value proposition of the neural models is therefore not accuracy but the mesh-free, differentiable, space-time representation they provide, together with the amortisation of inference once training is paid for.
